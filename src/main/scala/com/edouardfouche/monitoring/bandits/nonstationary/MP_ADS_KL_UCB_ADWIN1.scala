...
/**
  ...
  */
case class MP_ADS_KL_UCB_ADWIN1(delta: Double, ADR: Boolean = false)(val stream: Simulator, val reward: Reward, val scalingstrategy: ScalingStrategy, var k: Int) extends BanditKLUCB with BanditAdwin {
  val name = s"MP-ADS-KL-UCB-ADWIN1; d=$delta; r=$ADR"
