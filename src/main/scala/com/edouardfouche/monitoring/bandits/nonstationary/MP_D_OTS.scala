...
/**
  ...
  */
case class MP_D_OTS(gamma: Double)(val stream: Simulator, val reward: Reward, val scalingstrategy: ScalingStrategy, var k: Int) extends BanditTS {
  require((0 <= gamma) & (gamma <= 1.0))
  val name = s"MP-D-OTS; g=$gamma"
