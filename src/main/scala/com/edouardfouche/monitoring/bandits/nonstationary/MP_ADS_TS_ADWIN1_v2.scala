...
/**
  ...
  */
case class MP_ADS_TS_ADWIN1_v2(delta: Double, ADR: Boolean = false)(val stream: Simulator, val reward: Reward, val scalingstrategy: ScalingStrategy, var k: Int) extends BanditTS with BanditAdwin {
  val name = s"MP-ADS-TS-ADWIN1-v2; d=$delta; r=$ADR"
