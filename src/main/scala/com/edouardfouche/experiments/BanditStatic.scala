...
import com.edouardfouche.monitoring.bandits.nonstationary.{MP_AWR_Elimination_UCB, MP_AWR_TS, MP_AW_TS, MP_D_TS, MP_D_UCB, MP_E_Greedy, MP_GLR_KL_UCB_G, MP_GLR_KL_UCB_L, MP_M_UCB, MP_SW_TS, MP_SW_UCB, MP_SW_UCB_SHARP_A, MP_SW_UCB_SHARP_G}
